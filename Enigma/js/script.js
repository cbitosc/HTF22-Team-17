...
let refreshDOMTable=()=>{
    ...
    for(let i=0;i<cmsTableKeys.length;i++){
        ...
        currentEditBtn.innerHTML='<i class="fa fa-edit"></i>';
        currentDeleteBtn.innerHTML='<i class="fa fa-trash-alt"></i>';
    ...
    let enableDisableNewUserModal=(option) => {
        ...
        let newPersoAddress=document.getElementById('newPersonAddress');
    ...
    newPersonSubmitBtn.addEventListener('click',() => {
        ...
        if(newPersonName !== '' && newPersonName !== '' && newPersonAddress !== ''){
            let newPerson= {};
